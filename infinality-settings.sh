...
#USE_STYLE="UBUNTU_USE_KNOWN_SETTINGS_ON_SELECTED_FONTS"
#USE_STYLE="INFINALITY_NO_WINDOWS_RENDERING"
USE_STYLE="INFINALITY_NO_INCREASE_GLYPH_HEIGHTS"
#USE_STYLE="INFINALITY_NO_INCREASE_GLYPH_HEIGHTS_MORE_WIN_RENDERING"
#USE_STYLE="INFINALITY_WITH_FRINGE_FILTER"
#USE_STYLE=INFINALITY_WITH_FRINGE_FILTER_NO_HEIGHT_INCREASE
...
################# CUSTOM STYLE #################
if [ "$USE_STYLE" = "INFINALITY_NO_WINDOWS_RENDERING" ]; then
...
if [ "$USE_STYLE" = "INFINALITY_NO_INCREASE_GLYPH_HEIGHTS" ]; then
...
if [ "$USE_STYLE" = "INFINALITY_NO_INCREASE_GLYPH_HEIGHTS_MORE_WIN_RENDERING" ]; then
...
if [ "$USE_STYLE" = "INFINALITY_WITH_FRINGE_FILTER" ]; then
...
if [ "$USE_STYLE" = "INFINALITY_WITH_FRINGE_FILTER_NO_HEIGHT_INCREASE" ]; then
...
if [ "$USE_STYLE" = "UBUNTU_USE_KNOWN_SETTINGS_ON_SELECTED_FONTS" ]; then
